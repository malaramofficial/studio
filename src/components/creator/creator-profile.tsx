...
export function CreatorProfile({ creatorInfo }: CreatorProfileProps) {
  ...
  const creatorImageUrl = "https://images.unsplash.com/photo-1763922065273-4a73139aa6d5?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
